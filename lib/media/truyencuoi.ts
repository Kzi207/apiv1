...
const dataPath = path.join(__dirname, "data", "truyencuoi.json");
let list: string[] = [];
try {
...
export function getRandomTruyencuoi() {
...
export function randomHandler(req: any, res: any) {
  const data = getRandomTruyencuoi();
...
export default getRandomTruyencuoi;
