...
const dataPath = path.join(__dirname, "data", "videoanime.json");
let list: string[] = [];
try {
...
export function getRandomVideoanime() {
...
export function randomHandler(req: any, res: any) {
  const data = getRandomVideoanime();
...
export default getRandomVideoanime;
